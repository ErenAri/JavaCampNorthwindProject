...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getCategoryIdIn(List<Integer> categories) {
		return new SuccessDataResult<List<Product>>
		(this.productDao.getCategoryIn(categories),"Data listelendi");
	}
	...
	@Override
	public DataResult<List<Product>> getNameAndCategory(String productName, int categoryId) {
		return new SuccessDataResult<List<Product>>
		(this.productDao.getNameAndCategory(productName, categoryId),"Data listelendi");
	}
